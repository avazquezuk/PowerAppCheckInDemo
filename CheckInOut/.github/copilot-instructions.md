...
### Add Business Central Connection

For Business Central data access:

```bash
pac code add-data-source -a "shared_dynamicssmbsaas" -c <connectionId>
```

This enables access to Business Central APIs and OData endpoints. You can then 
use the generated service classes to interact with Business Central entities 
such as customers, vendors, items, sales orders, and other business data.

**Note:** Ensure your Business Central connection has the appropriate 
permissions for the entities you need to access.
